...
//   TQAStatus,
// } from '../Models/qa';
// import useSetQAListQueryData from '../QueryDataHooks/useSetQAListQueryData';
// import {Platform} from 'react-native';
// import {Contact} from '../Models/contacts';
// import {IProjectFloor} from '../Models/location';
// import useSetQAQueryData from '../QueryDataHooks/useSetQAQueryData';
// import {Company} from '../Models/company';
// import useSetQaCommentQueryData from '../QueryDataHooks/useSetQaCommentQueryData';
...
//     queryFn: async ({pageParam = defectURL}) => {
//       try {
//         const response = await axios.get<AxiosInfiniteReturn<QAList>>(
//           pageParam,
//           {
//             headers: {
...
//     queryFn: async () => {
//       try {
//         const response = await axios.get<QAList>(defectURL, {
//           headers: {
//             Authorization: 'Bearer ' + accessToken,
//             'User-Company': company!.companyId,
//           },
...
//     queryFn: async ({pageParam = defectURL}) => {
//       try {
//         const response = await axios.get<AxiosInfiniteReturn<QAWithFirstImg>>(
//           pageParam,
//           {
//             headers: {
//               Authorization: 'Bearer ' + accessToken,
...
//     queryFn: async () => {
//       try {
//         const response = await axios.get<QAWithFirstImg>(url, {
//           headers: {
//             Authorization: 'Bearer ' + accessToken,
//             'User-Company': company!.companyId,
//           },
...
//     queryFn: async () => {
//       try {
//         const response = await axios.get<InfiniteAxiosQueryData<QAComment>>(
//           url,
//           {
//             headers: {
//               Authorization: 'Bearer ' + accessToken,
...
//   qaItem,
// }: AddQAComment) => {
//   const {handleAddQAList} = useSetQaCommentQueryData({qaItem});
